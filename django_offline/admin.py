...
from .admin_site import django_offline_admin
...
@admin.register(Token, site=django_offline_admin)
...
@admin.register(IncomingTransaction, site=django_offline_admin)
...
@admin.register(OutgoingTransaction, site=django_offline_admin)
...
@admin.register(Client, site=django_offline_admin)
class ClientAdmin(HostAdmin):
    pass


@admin.register(Server, site=django_offline_admin)
