...
from sync_old import (OutgoingTransactionMiddleManResource, OutgoingTransactionServerResource,
                  MiddleManTransactionResource, OutgoingTransactionSiteServerResource)
from sync_old import (index, view_transaction, consume_transactions,
...
# The order is important, referred to from sync_old.urls and {app_name}_dispatch.urls
urlpatterns += patterns('',
