...
from sync_old import OutgoingTransaction

from sync_old import BaseSyncDeviceTests
from sync_old import MiddleManTransactionFactory, ProducerFactory
...
#         print 'Number of Middle Men Transactions so far: {0}'.format(MiddleManTransaction.objects.all().count())
    ...
    def test_tastypie_synchronizing_link(self):
        ...
        # FIXME: use reverse
        self.assertRedirects(response, '/dispatch/bcpp/sync_old/' + producer + '/')
