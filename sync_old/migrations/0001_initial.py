...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('sync_old', ['IncomingTransaction'])
        ...
        db.send_create_signal('sync_old', ['OutgoingTransaction'])
        ...
        db.send_create_signal('sync_old', ['MiddleManTransaction'])
        ...
        db.send_create_signal('sync_old', ['Producer'])
        ...
        db.create_table('bhp_sync_requestlog', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('producer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sync_old.Producer'])),
        ...
        db.send_create_signal('sync_old', ['RequestLog'])
        ...
        db.send_create_signal('sync_old', ['TestItem'])
    ...
    models = {
        ...
        'sync_old.requestlog': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'producer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sync_old.Producer']"}),
